...
export default function TopSellingSection({ limit, carousel }: Props) {
  const products = limit ? topSelling.slice(0, limit) : topSelling
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 pt-3 mb-20">
  ...
  // ===== MAIN RETURN =====
  return (
    <div className="container mx-auto px-2 pt-3 mb-10">
      <div className="mb-10 mt-3">
        <p className="text-xs font-semibold tracking-[0.3em] text-zinc-400 uppercase mb-2">
          Just In
        </p>
